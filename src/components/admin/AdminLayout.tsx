...
import { BarChart2, Building2, CreditCard, Sparkles, Layers, User, Zap, Menu, X, LifeBuoy, Stethoscope } from 'lucide-react'

const nav = [
  { href: '/admin',               Icon: BarChart2,   label: 'Dashboard',      exact: true },
  { href: '/admin/clinics',       Icon: Building2,   label: 'Clínicas',       exact: false },
  { href: '/admin/vets',          Icon: Stethoscope, label: 'Veterinarios',   exact: false },
